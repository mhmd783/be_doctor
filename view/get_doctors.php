...
if (isset($_GET['id'])) { 
    ...
    if($specialty!=''&&$city!=''){
        ...
        $get = $database->prepare("SELECT * FROM `doctor`WHERE `id`<:id AND `id`>=:ide AND `specialty`=:specialty AND `city`=:city ORDER BY `id` DESC");
    ...
    if($specialty!=''&&$city==''){
        ...
        $get = $database->prepare("SELECT * FROM `doctor`WHERE `id`<:id AND `id`>=:ide AND `specialty`=:specialty ORDER BY `id` DESC");
        $get->bindParam(":id", $id_poststart);
        $get->bindParam(":ide", $id_postend);
        $get->bindParam(":specialty", $specialty);
        $get->execute();
    ...
    if($specialty==''&&$city!=''){
        ...
        $get = $database->prepare("SELECT * FROM `doctor`WHERE `id`<:id AND `id`>=:ide AND `city`=:city ORDER BY `id` DESC");
        $get->bindParam(":id", $id_poststart);
        $get->bindParam(":ide", $id_postend);
        $get->bindParam(":city", $city);
        $get->execute();
